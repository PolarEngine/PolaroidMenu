...
using static PolaroidMenu.Menu.Buttons;
        ...
        public static void Prefix()
        {
            ...
            // Constant
                ...
                if (navType == 1)
                {
                    ...
                    {
                        PolaroidMenu.Classes.Button.buttonCooldown = Time.time + 0.2f;
                        GorillaTagger.Instance.StartVibration(rightHanded, GorillaTagger.Instance.tagHapticStrength / 2f, GorillaTagger.Instance.tagHapticDuration / 2f);
                        GorillaTagger.Instance.offlineVRRig.PlayHandTapLocal(8, rightHanded, 0.4f);
                        Toggle("NextPage");
                    }

                if (Time.time > PolaroidMenu.Classes.Button.buttonCooldown && ControllerInputPoller.instance.leftControllerIndexFloat > 0f)
                {
                    PolaroidMenu.Classes.Button.buttonCooldown = Time.time + 0.2f;
                    GorillaTagger.Instance.StartVibration(rightHanded, GorillaTagger.Instance.tagHapticStrength / 2f, GorillaTagger.Instance.tagHapticDuration / 2f);
                    GorillaTagger.Instance.offlineVRRig.PlayHandTapLocal(8, rightHanded, 0.4f);
